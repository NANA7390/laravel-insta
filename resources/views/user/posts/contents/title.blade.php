    ...
    <div class="row align-items-center">
        <div class="col-auto">
            ...
            <a href="{{ route('profile.show', $post->user->id) }}">
                 @if($post->user->avatar)
                <img src="{{ $post->user->avatar }}" alt="" class="image-sm rounded-circle">
                @else
        ...
        <div class="col-auto">
            <div class="dropdown">
                ...
                {{-- edit/delete, dropdown make area for hidden --}}
                ...
                @include('user.posts.modals.delete')
                @else
                {{-- unfollow/follow --}}
                <div class="dropdown-menu">
